    ...
    return function () {
        ...
        var i = {
            ...
            s = {
                ...
                showEvent: "focus",
                autoClose: !1,
                prevHtml: '<svg><path d="M 17,12 l -7,7 l 7,7"></path></svg>',
                nextHtml: '<svg><path d="M 14,12 l 7,7 l -7,7"></path></svg>',
                navTitles: {
                    days: "MMMM, yyyy",
                    months: "yyyy",
                    years: "yyyy1 - yyyy2"
        ...
        class V {
            ...
            _buildBaseHtml() {
                ...
                this.$el.innerHTML = '<div class="air-datepicker-nav--action order-1 ms-auto " data-action="prev" >'.concat(e, "</div>") + '<div class="air-datepicker-nav--title order-0"></div>' + '<div class="air-datepicker-nav--action  order-2" data-action="next">'.concat(t, "</div>")
            }
            get isNavIsFunction() {
                let {
                    navTitles: e
